...
ped_partition_typeped_partition_type = {
    0x00: 'NORMAL',
    0x01: 'LOGICAL',
    0x02: 'EXTENDED',
    0x04: 'FREESPACE',
...
ped_partition_flag = {
    1: 'PED_PARTITION_BOOT',
    2: 'PED_PARTITION_ROOT',
    3: 'PED_PARTITION_SWAP',
    4: 'PED_PARTITION_HIDDEN',
    5: 'PED_PARTITION_RAID',
    6: 'PED_PARTITION_LVM',
    7: 'PED_PARTITION_LBA',
    8: 'PED_PARTITION_HPSERVICE',
    9: 'PED_PARTITION_PALO',
    10: 'PED_PARTITION_PREP',
    11: 'PED_PARTITION_MSFT_RESERVED',
    12: 'PED_PARTITION_BIOS_GRUB',
    13: 'PED_PARTITION_APPLE_TV_RECOVERY',
    14: 'PED_PARTITION_DIAG',
    15: 'PED_PARTITION_LEGACY_BOOT'
}
...
constraint_new.argtypes = [POINTER(PedAlignment), POINTER(PedAlignment), POINTER(PedGeometry), POINTER(PedGeometry),
                           PedSector, PedSector]
